...
### Function used for the chi-squared test
...
### Functions used to save/read relevant data into files 
...
### Functions used to save/read relevant data within single iterations
##
